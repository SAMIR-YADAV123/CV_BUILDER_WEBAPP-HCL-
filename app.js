...
var project_count=1;
function Download(){
       var down=document.getElementById('pos');
...
function addProject(){
    let addExperience = document.getElementById('addProject');
    let experienceHide = document.getElementById('project_hide');
    if(project_count<3)
    {
        ++project_count;
        var field = 
        `<div class="mb-3">
            ...
            <input type="text" name="ptitle${project_count}" class="form-control">
        </div>
        <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label">Description</label>
            <input type="text" name="pdescription${project_count}" class="form-control">
        </div>`;
        var htmlObject = document.createElement('div');
        htmlObject.innerHTML=field;
